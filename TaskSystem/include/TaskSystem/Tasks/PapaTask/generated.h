...
static int send(PapaTask this, Message data, int targetTaskID);
...
// does the same thing
static int send(PapaTask this, Message data, int targetPapaTaskID){
	return Comm->send(Comm, data, targetPapaTaskID);
}
